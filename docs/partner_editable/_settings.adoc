...
:partner-product-name: Trend Micro Cloud One(TM) – Conformity AWS Control Tower Integration
...
:marketplace_listing_url: https://aws.amazon.com/marketplace/pp/prodview-g232pyu6l55l4
